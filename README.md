...
The Barely QR standard consists of a 15x15 grid of bits segmented into groups of 5 bits. This enables each group to represent one of 32 characters. Supported characters are lowercase english letters, /, :, ?, space, and blank. The bottom right 5x5 segment is reserved for the doge identification tile that enables unmatched performance for cameras to start reading the bits.
